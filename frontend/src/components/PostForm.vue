  ...
  <div>
    ...
    <BaseModal :isOpen="isModalOpen" @close="closeModal">
      ...
      <form @submit.prevent="submitPost" class="space-y-6">
        <div>
          <label for="track-search" class="block text-sm font-medium text-gray-700 mb-2">Search Spotify:</label>
          ...
          <ul v-if="searchResults.length" class="mt-2 bg-white border border-gray-200 rounded-lg shadow-lg max-h-60 overflow-y-auto">
        ...
        <div v-if="selectedTrack" class="p-4 border border-gray-200 rounded-lg bg-gray-50">
          <h3 class="text-lg font-semibold">Selected Track</h3>
          <div class="flex items-center space-x-4">
            <img :src="selectedTrack.album.images[0]?.url" alt="Album Art" class="w-20 h-20 rounded-lg">
